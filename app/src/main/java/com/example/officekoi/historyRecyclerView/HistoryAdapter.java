...
public class HistoryAdapter extends RecyclerView.Adapter<HistoryViewHolders> {
    ...
    public HistoryViewHolders onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View layoutView = LayoutInflater.from(parent.getContext()).inflate(R.layout.activity_history, null, false);
    ...
    public void onBindViewHolder(HistoryViewHolders holder, final int position) {
        holder.spaceId.setText(itemList.get(position).getSpaceId());
